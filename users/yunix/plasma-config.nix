{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-e1bbce15-23ae-40da-85ea-6cbb8649f18c" = [];
      ...
      "services.services.Alacritty.desktop"."_launch" = "Meta+Return";
      "services.services.firefox.desktop"."_launch" = "Meta+B";
      "services.services.org.kde.krunner.desktop"."_launch" = "Meta+Space";
    ...
    configFile = {
      ...
      "kcminputrc"."Libinput.1133.49291.Logitech G502 HERO Gaming Mouse"."ScrollFactor" = 1;
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "2560,1377";
      ...
      "kdeglobals"."General"."fixed" = "Agave Nerd Font,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."font" = "Agave Nerd Font,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."menuFont" = "Agave Nerd Font,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."smallestReadableFont" = "Hack,8,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."toolBarFont" = "Agave Nerd Font,10,-1,5,50,0,0,0,0,0";
      ...
      "kdeglobals"."Shortcuts"."AddBookmark" = "";
      "kdeglobals"."WM"."activeBackground" = "30,30,46";
      "kdeglobals"."WM"."activeBlend" = "205,214,244";
      "kdeglobals"."WM"."activeFont" = "Agave Nerd Font,10,-1,5,50,0,0,0,0,0";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{1b031333-d49e-4022-8628-d24c6cea68e1}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{c8ee9bbb-8091-40bd-9e4c-4d2fc666ccd3}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{cd023dd0-8073-4722-ad62-df4772e0fded}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{079eb8c5-16a8-4249-b8d2-8d099f084308}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{8f85fdc3-e554-4c7f-a91f-9594e4ffab80}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{94b34bd3-68d9-4962-840d-c21ef53668ef}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{fef66030-bd7e-44c6-ac9a-d1b85642fb2c}";
      ...
      "khotkeysrc"."Shortcuts"."AddBookmark[$d]" = "";
      ...
      "kscreenlockerrc"."Daemon"."Timeout" = 25;
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "/home/yunix/Pictures/Wallpaper/default.png";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."PreviewImage" = "/home/yunix/Pictures/Wallpaper/default.png";
      ...
      "kwinrc"."Desktops"."Id_1" = "271937b5-de37-4dc1-b572-1bf3353ba3a2";
      "kwinrc"."Desktops"."Id_2" = "b80d5689-5e09-4ebc-88d7-79523aace8ed";
      "kwinrc"."Desktops"."Id_3" = "f758225b-5ced-46ab-91f7-4997fe7e33f3";
      "kwinrc"."Desktops"."Id_4" = "02ccefda-2930-44d0-917e-3dafbbd55d2d";
      "kwinrc"."Desktops"."Id_5" = "cc68cf15-c4e9-4348-927a-8a2f8ba397d1";
      ...
      "kwinrc"."Tiling.213a9620-187e-58a6-b80b-85d8fb95dfce"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
      "kwinrc"."Tiling.2cfb1076-3a70-54ef-b9d3-5781fe9104bb"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.2efe0ebf-1621-5b1a-81aa-fa872867cfda"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.55a6aa92-3c2e-5054-bf72-9b046f7b1906"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.69189006-6fe1-5150-806b-6437ee5b7272"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
